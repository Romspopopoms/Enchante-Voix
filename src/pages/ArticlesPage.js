      ...
      <div className="flex flex-col w-[90%] space-y-6">
        {articles.length > 0 ? (
          articles.map((article, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow-lg flex flex-col space-y-4">
              ...
              {article.imageurl && (
                <img src={article.imageurl} alt={article.title} className="w-full max-h-[50%] object-cover rounded-md"/>
              )}
              {article.videourl && (
